...
//        }
        ...
        // 初始化完毕, 绑定控制器
        if ( _config.controller instanceof Fan.ui.ViewController ) {
...
//                Fan.util.TouchManager.remove( this.getDom() );
        ...
        _config = _dom = _innerDom = _subViewMap = _isInParent = _isInited = _parentDom = _processLoadUI = null;
